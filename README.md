...
## 나라장터 API 는 서비스마다 활용신청을 따로 합니다

인증키 하나로 다 되는 게 아닙니다. 공공데이터포털(data.go.kr)에서
**서비스별로** [활용신청] 을 눌러야 합니다.

| 서비스 | 무엇에 쓰나 | 없으면 |
|---|---|---|
| 조달청_입찰공고정보서비스 | 공고 수집 | 아무것도 안 모임 |
| 조달청_공공기관 사전규격정보서비스 | 사전규격 수집 | 사전공고 탭이 빔 |
| 조달청_낙찰정보서비스 | 낙찰업체·작년 수행업체 | **"작년 수행업체 기록 없음" · 낙찰업체-찾기 0건** |

입찰공고는 되는데 "누가 따갔나" 만 안 나오면 낙찰정보서비스를 신청하지
않은 것입니다. 인증키가 틀린 게 아닙니다 — 그 경우 화면에 신청 방법이
그대로 나옵니다.
